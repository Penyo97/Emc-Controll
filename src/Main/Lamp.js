...
function Lamp() {
  return (
    <div className="Lamp__Container">
      <svg version="1.1" viewBox="0 0 40.9 64" className="Lamp">
        <defs>
          <filter id="shadow">
            <feDropShadow
              dx="0"
        ...
        <path
          className="Lamp__yellow"
          filter="url(#shadow)"
          d="M31,43v5c0,0.6-0.4,1-1,1h-3c0,1.7-1.3,3-3,3l0,0c-1.7,0-3-1.3-3-3h-3c-0.6,0-1-0.4-1-1v-5h1
	...
	C31.3,36.4,30,39.6,30,43l0,0H31z"
        />
        <path
          className="Lamp__black"
          d="M30,49h-3c0,1.7-1.3,3-3,3l0,0c-1.7,0-3-1.3-3-3h-3c-0.6,0-1-0.4-1-1v-5h14v5C31,48.6,30.6,49,30,49z"
        />
        <polygon
          className="Lamp__red"
          points="30,24.2 25.8,23.4 28.3,16 19,26.6 23.2,27.5 20.7,34 "
        />
        <path
          d="M39.9,57.4c-1.2-1.8-3.7-2.4-5.5-1.2c-0.5,0.3-0.9,0.7-1.2,1.2L32.8,58c-0.8,1.3-2.2,2-3.7,2c-2.2,0-4.1-1.8-4.1-4.1v-3.1
	...
	c-2.4,2.3-3.8,5.4-4,8.6H19c-0.2-3.3-1.6-6.3-3.9-8.6c-5.2-5-5.4-13.2-0.5-18.4C19.5,9.8,27.8,9.6,33,14.6z"
        />
        <path
          d="M30.7,23.5c-0.1-0.1-0.3-0.2-0.5-0.3l-3.1-0.6l2.2-6.3c0.2-0.5-0.1-1.1-0.6-1.3c-0.4-0.1-0.8,0-1.1,0.3L18.3,26
